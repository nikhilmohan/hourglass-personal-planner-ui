...
class Favourites extends Component {
    ...
    componentDidMount () {
         ...
         Axios.get('http://localhost:9900/favourites-service/favourites/user/' + this.props.id + '/movies')
            .then(response => {
        ...
        Axios.get('http://localhost:9900/favourites-service/favourites/user/' + this.props.id + '/trivia')
        .then(response => {
            console.log(response);
